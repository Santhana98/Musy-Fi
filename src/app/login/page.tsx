  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl shadow-2xl relative z-10 flex flex-col items-center">
        ...
        <div className="w-full flex items-center justify-between my-4 gap-2 text-zinc-500 text-[10px] font-bold uppercase tracking-wider">
        ...
        <button
          ...
          className="w-full border border-zinc-700 hover:border-[#D62828] bg-zinc-950/60 hover:bg-zinc-900/80 text-white font-bold text-sm py-2.5 rounded-full transition-all flex items-center justify-center gap-2 active:scale-98 hover:scale-[1.01]"
        >
